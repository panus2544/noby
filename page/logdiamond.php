<?php
$SQL2 = $odb->prepare("SELECT * FROM logdiamond WHERE id = :id");
...
<div class="card">
    <div class="card-body">
        ...
        <div class="alert alert-dismissible alert-warning">
            <center><p class="mb-0">ท่านต้องโอน robux เป็นจำนวน <?Php echo $column2["diamond"]; ?> R$</p></center>
        </div>

        <div class="form-group">
            <label class="col-form-label" for="inputDefault">ยูสเซอร์เนม</label>
            <input type="text" class="form-control" placeholder="กรุณากรอกจำนวนโรบัค" disabled value="<?Php echo $column2["userid"]; ?> " id="robuxzaza">
        </div>
        <div class="form-group">
            <label class="col-form-label" for="inputDefault">รหัสผ่าน</label>
            <input type="text" class="form-control" placeholder="กรุณากรอกจำนวนพ้อยต์" disabled value="<?Php echo $column2["gamename"]; ?> " id="pointzaza">
        </div>
        <div class="col-xs-12 text-center">
